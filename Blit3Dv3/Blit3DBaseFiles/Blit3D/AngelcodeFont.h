...
public:
	...
	//Draws the text from the top-right corner of the text string
	void BlitText(float x, float y, std::string output);
	void BlitText(float x, float y, float scale_val_x, float scale_val_y, std::string output);

	//Draws the text from the center of the text string
	void BlitAutoText(float x, float y, std::string text);
	void BlitAutoText(float x, float y, float scale_x, float scale_y, std::string output);
